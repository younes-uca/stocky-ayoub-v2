...
public class BeneficiaireConverter extends AbstractConverter<Beneficiaire, BeneficiaireDto> {
    ...
    public  BeneficiaireConverter(){
        super(Beneficiaire.class, BeneficiaireDto.class);
    }

    @Override
    public Beneficiaire toItem(BeneficiaireDto dto) {
        if (dto == null) {
            return null;
        } else {
        Beneficiaire item = new Beneficiaire();
    ...
    @Override
    public BeneficiaireDto toDto(Beneficiaire item) {
        if (item == null) {
            return null;
        } else {
