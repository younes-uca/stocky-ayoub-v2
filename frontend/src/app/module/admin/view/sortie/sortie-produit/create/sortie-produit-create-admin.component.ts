...
export class SortieProduitCreateAdminComponent extends AbstractCreateController<SortieProduitDto, SortieProduitCriteria, SortieProduitAdminService>  implements OnInit {
   ...
   private _validSortieProduitReference = true;
    ...
    public validateSortieProduitItemsPrix(){
    ...
    public validateSortieProduitItemsRemise(){
    ...
    public validateSortieProduitItemsPrixUnitaireTtc(){
    ...
    public validateSortieProduitItemsPrixUht(){
    ...
    public validateSortieProduitItemsMontantHt(){
    ...
    public validateSortieProduitItemsMontantTtc(){
