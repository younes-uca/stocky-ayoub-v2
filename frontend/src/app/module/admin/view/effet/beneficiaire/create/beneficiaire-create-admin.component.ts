...
@Component({
  selector: 'app-beneficiaire-create-admin',
  templateUrl: './beneficiaire-create-admin.component.html'
})
export class BeneficiaireCreateAdminComponent extends AbstractCreateController<BeneficiaireDto, BeneficiaireCriteria, BeneficiaireAdminService>  implements OnInit {
