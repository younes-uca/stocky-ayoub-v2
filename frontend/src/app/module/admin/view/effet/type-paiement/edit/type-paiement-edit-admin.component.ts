...
export class TypePaiementEditAdminComponent extends AbstractEditController<TypePaiementDto, TypePaiementCriteria, TypePaiementAdminService>   implements OnInit {
