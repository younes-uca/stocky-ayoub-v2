...
@Component({
  selector: 'app-proprietaire-cheque-effet-edit-admin',
  templateUrl: './proprietaire-cheque-effet-edit-admin.component.html'
})
export class ProprietaireChequeEffetEditAdminComponent extends AbstractEditController<ProprietaireChequeEffetDto, ProprietaireChequeEffetCriteria, ProprietaireChequeEffetAdminService>   implements OnInit {
