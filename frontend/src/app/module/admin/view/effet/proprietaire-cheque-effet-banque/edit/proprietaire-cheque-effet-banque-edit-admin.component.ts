...
@Component({
  selector: 'app-proprietaire-cheque-effet-banque-edit-admin',
  templateUrl: './proprietaire-cheque-effet-banque-edit-admin.component.html'
})
export class ProprietaireChequeEffetBanqueEditAdminComponent extends AbstractEditController<ProprietaireChequeEffetBanqueDto, ProprietaireChequeEffetBanqueCriteria, ProprietaireChequeEffetBanqueAdminService>   implements OnInit {
